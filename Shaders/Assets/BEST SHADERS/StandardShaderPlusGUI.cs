...
public class StandardShaderPlusGUI : ShaderGUI
{
    ...
    private static class Styles
    {
        ...
        public static GUIContent zTestText = new GUIContent("ZTest", "ZTest");
    }
    ...
    public void ShaderPropertiesGUI(Material material)
    {
        ...
        GUILayout.Label("Plus Options", EditorStyles.boldLabel);

        if (cullMode != null)
            m_MaterialEditor.ShaderProperty(cullMode, Styles.cullModeText);
        if (zTest != null)
            m_MaterialEditor.ShaderProperty(zTest, Styles.zTestText);
